...
const Navbar = () => {
  ...
  return (
   <div className='z-4 fixed flex justify-between items-start top-0 w-full'>
    <div className='p-2'>
        <div className='lg:w-40 w-13 h-11'>
   ...
   className='lg:h-12 h-9 lg:w-[19vw] w-[22vw] relative'>
    <div className='bg-black h-full w-full relative '>
        <div className='relative h-full lg:px-10 px-1.5 flex flex-col justify-center items-end gap-1'>
            <div className='h-0.5 lg:w-19 w-8 bg-emerald-200/80 z-2'></div>
        <div className='h-0.5 lg:w-10 w-5 bg-emerald-300/70 z-2'></div>
        </div>
    </div>
