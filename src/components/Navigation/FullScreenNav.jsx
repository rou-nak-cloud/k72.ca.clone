            ...
            <div className='link origin-top border-t-1 border-white/50 relative'>
                ...
                <div className='moveLink absolute flex top-0 bg-[#D3FD50] text-black cursor-cell'>
                    <div className='moveX flex items-center'>
                        <h2 className='whitespace-nowrap font-[font300] text-[8vw] text-center lg:pt-3 pt-1  leading-[.9] uppercase'>Pour Tout Voir</h2>
                        <img className='lg:h-26 h-10 w-80 shrink-0 object-cover rounded-full' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                        <h2 className='whitespace-nowrap font-[font300] text-[8vw] text-center lg:pt-3 pt-1 leading-[.9] uppercase'>Pour Tout Voir</h2>
                        <img className='lg:h-26 h-10  lg:w-80 w-80 shrink-0 object-cover rounded-full' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                    </div>   
                    <div className='moveX flex items-center'>
                        <h2 className='whitespace-nowrap font-[font300] text-[8vw] text-center lg:pt-3 pt-1 leading-[.9] uppercase'>Pour Tout Voir</h2>
                        <img className='lg:h-26 h-10  w-80 shrink-0 object-cover rounded-full' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
